...
/**
 * Servlet implementation class SeriesBySeason
 */
@WebServlet("/SeriesBySeasonHigh")
public class SeriesBySeasonHigh extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SeriesBySeasonHigh() {
        super();
		...
		PrintWriter out = response.getWriter();
	 	...
	 	JSONArray PeliculasActor = new JSONArray();
	 	 ...
	 	 try ( EmbeddedNeo4j greeter = new EmbeddedNeo4j( "bolt://localhost:7687", "Proyecto", "Prueba1234" ) )
	        {
			 	LinkedList<String> myactors = greeter.getSeriesBySeasonHigh();
