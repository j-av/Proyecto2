 ...
 */
@WebServlet("/SeriesByPais")
public class SeriesByPais extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PrintWriter out = response.getWriter();
	 	...
	 	String myActor = request.getParameter("pais_name");
	 	 try ( EmbeddedNeo4j greeter = new EmbeddedNeo4j( "bolt://localhost:7687", "Proyecto", "Prueba1234" ) )
	        {
			 	LinkedList<String> myactors = greeter.getSeriesByPais(myActor);
